...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "allows_write_to_pm", sa.Boolean(), server_default="false", nullable=False
        ),
        ...
        sa.Column(
            "purchased_languages", sa.JSON(), server_default="[]", nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_economy_transactions_user_id"), "economy_transactions", ["user_id"]
    )
    ...
    op.create_index(
        op.f("ix_social_interactions_from_user"), "social_interactions", ["from_user"]
    )
    op.create_index(
        op.f("ix_social_interactions_to_user"), "social_interactions", ["to_user"]
    )
    op.create_index(
        op.f("ix_social_interactions_game_id"), "social_interactions", ["game_id"]
    )
